# OpenAPI description module admin-bonus
...
Feature #38 создает начальный публичный административный REST surface module admin-bonus. Полная спецификация модуля совпадает с feature OpenAPI и должна оставаться синхронизированной с runtime Swagger group admin-bonus.
