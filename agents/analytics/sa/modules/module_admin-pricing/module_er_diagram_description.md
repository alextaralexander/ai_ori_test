# ER description. Module admin-pricing
...
## Scope
Этот canonical module artifact описывает полную модель данных module_admin-pricing после включения feature #31; последующие фичи должны расширять этот файл без потери описанных ограничений и package ownership.
